...
export default function DataApproval({ report, startDate, endDate, approved, onApprove, onGenerate, onReturn }) {
  return (
    <section className="screen approval-screen" aria-labelledby="approval-title">
      ...
      <div className="actions no-print"><button className="button secondary" onClick={onReturn}>← Back to Validation</button><button className="button primary" disabled={!approved} onClick={onGenerate}>Generate Weekly Report <span aria-hidden="true">→</span></button></div>
    </section>
  );
}
